...
<head>
    ...
    <style>
        ...
        .frame { display: none; width: 100%; max-width: 896px; }
...
'''
        ...
        for i in range(total_frames):
            frame_path = frames_dir + "/frame_" + str(i).zfill(4) + ".png"
            img_tag = '<img src="' + frame_path + '" class="frame" id="frame' + str(i) + '" alt="Frame ' + str(i) + '" />' + '\n'
    ...
    <script>
        ...
        function showFrame(index) {
            ...
            document.getElementById('status').textContent = 'Frame ' + (index + 1) + '/' + frames.length;
        }
